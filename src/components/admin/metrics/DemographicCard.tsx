...
export default function DemographicCard() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5   sm:p-6">
      ...
      <div className="px-4 py-6 my-6 overflow-hidden border border-gray-200 rounded-2xl bg-gray-50 sm:px-6">
        <div
          id="mapOne"
      ...
      <div className="space-y-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            ...
            <p className="font-medium text-gray-800 text-theme-sm   ">79%</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            ...
            <p className="font-medium text-gray-800 text-theme-sm   ">23%</p>
          </div>
        </div>
      </div>
    </div>
