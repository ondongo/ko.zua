...
const SkeletonProductCard = () => {
  return (
    <div className="min-w-[170px] max-w-[180px] lg:max-w-[385px]  max-h-[470px]  lg:max-h-[600px] mx-auto sm:mx-0 bg-white shadow-sm rounded-lg overflow-hidden  border-2 border-[#FAFAFA] animate-pulse">
      {/* Image Placeholder */}
