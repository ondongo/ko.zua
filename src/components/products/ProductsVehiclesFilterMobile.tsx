...
const ProductsVehiclesFilterMobile: React.FC<ProductsFilterProps> = ({
  ...
  return (
    <div         
      className={`px-[10px] pt-[40px] rounded-lg 
      }`}
    >
      {/* Categories */}
      ...
      {/* Locations */}
      <div className="filter-subject-item pb-4  mt-4">
        <h1 className="text-black text-base font-semibold mb-4">
          Localisation
        </h1>
        <select
...
export default ProductsVehiclesFilterMobile;
