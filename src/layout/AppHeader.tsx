      ...
      <div className="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 xl:py-4">
          ...
          <Link href="/" className="xl:hidden">
            <div className="relative w-[130px] h-[40px] overflow-hidden ">
              <Image
                src="/Kozua v3.png"
                alt="logo"
                layout="fill"
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-gray-700 rounded-xl z-99999 hover:bg-gray-100 xl:hidden"
          >
            <svg
              width="24"
              height="24"
            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10  xl:w-[430px]"
                />

                <button className="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-xl border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 ">
                  <span> ⌘ </span>
                  <span> K </span>
                </button>
              </div>
