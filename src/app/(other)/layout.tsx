              ...
              <div className="relative h-72 lg:min-h-dvh">
                ...
                <div className="relative z-10 flex h-full items-center justify-center">
                  <div className="mx-auto text-center max-w-lg px-0 ">
                    ...
                    >
                      Confiez-nous votre véhicule ou votre bien immobilier.
                      Notre équipe s’occupe de tout : photos, mise en ligne et
                      gestion des réservations. Vous gagnez en temps, en
                      tranquillité et en revenus.
